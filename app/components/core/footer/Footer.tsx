        ...
        <footer id="contact" className={styles.footer}>
            <div className={styles.topPart}>
                <div className={clsx(styles.linkPart, styles.footerHoverPart)}>
                    <p>Want to see<br/>your idea live?<br/> <a href="#" className={styles.footerHoverPartLink}><span className={styles.footerHoverPartLinkTextIn}><span>Let’s</span> <span>talk.</span></span><span className={styles.footerHoverPartLinkTextOut}><span>Let’s</span> <span>build</span> <span>together.</span></span></a></p>
